...
public class ProfessorGroupStudentsPanel extends JPanel {
    private String currentUser;
    
    public ProfessorGroupStudentsPanel(String currentUser) {
    ...
    private void initComponents() {
        ...
        setBorder(BorderFactory.createTitledBorder("Estudiantes del Grupo"));
        ...
        JButton viewBtn = new JButton("Ver Estudiantes");
        
        DefaultTableModel model = new DefaultTableModel(
            new String[]{"ID", "Usuario", "Nombre", "Apellido", "Calificación"}, 0
        );
